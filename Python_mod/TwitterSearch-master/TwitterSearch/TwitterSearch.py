...
class TwitterSearch(object):
    ...
    def __init__(self, consumer_key, consumer_secret,
        ...
        # app modified
        self.__consumer_key = 'MIhCVhaCeOmvpUVolppG97P8n'
        self.__consumer_secret = 'GXFHOrbvUAzUiYucrJNtVx0caEihQT0pxBxZXqgoeVa4iH1SyY'

        # user
        self.__access_token = '3471712154-ny0pLe4TUT7pMpEkMPFnwKtMZW1mz2G8zYfbRix'
        self.__access_token_secret = '4BZzGLq9AljkkXBQtiSG2fav0842MuK8RtYXcJy4taqc4'
